...
//       <Image
//         source={require('../service/1286tY.png')}
...
//       <Image
//         source={require('../service/OrMidN.png')}
...
//       <Text style={{ fontSize: 13, color: '#000',width:100,textAlign:"center",padding:10}}>Tailoring</Text>
      
//       <Text style={{ fontSize: 13, color: '#000',width:100,marginHorizontal:20,textAlign:"center",padding:10}}>Aari work</Text>
...
const Tailoring  = ({ navigation }) => {
  const array = [
    {
      key: '1',
      titleImageSource: require('../service/O8pVJF.png'),
      subtitle: 'Tailoring',
    },
    {
      key: '2',
      titleImageSource: require('../service/ApVpUs.png'),
      subtitle: 'Aari work',
    },
    {
      key: '3',
